...
We expect all of the following deliverables:
   ...
   -   **D1: Business case** including financial analysis (documentation repo)
       ...
       you'll meet solvency requirements.  
       This should be a Google Doc based on the 
       Business Case template document (see the [Resources](./../appendices/reqources.md) section), which you link in the readme of the repo.  
   ...
   -   **D2: Project website** (documentation repo)   
       Marketing website showcasing your company and launch product.Link and admin credentials are
       provided in the readme of the repo.  
       This is a Google site.   
       Details on the contents of this website will be handled in the
   ...
   -   **D3: Analysis document** (documentation repo)  
       ...
       This should be a
       Google Doc based on the Analysis template document (see the [Resources](./../appendices/reqources.md) section), which you link in the
       readme of the repo.  
       ...
       diagrammes /UCD / ERD ….) to describe the project.  
       ...
       than the POC implementation thereof. 

   -   **D4: Partial exam**  (Leho & exam repo)  
       Over the course of the first 5 weeks, you will acquire knowledge of both client and server
       basic technologies related to the project through a combination of knowledge clips and self-study.  
       In the first project week, you will complete an individual quiz/exam to assess their acquired knowledge. This will serve as a foundation, allowing
   ...
   -   **D6: Project work, peer evaluations and retrospections** (Leho & in gitlab)   
       ...
       otherwise) must be created and assigned in gitlab. Each Team member will log their work time they perform under the correct issue.  
       Throughout the semester, we will implement various peer assessments and
