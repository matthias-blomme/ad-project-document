...
_Wireframe deliverable_: A single wireframe, one with the full-fledged event browser, on a
...
_Wireframe deliverable_: Two wireframes, one with the full-fledged event browser, on a resolution
...
_Wireframe deliverable_: Two wireframes, one for the worker logging setting and one for the
...
_Wireframe deliverable_: Two wireframes, one for rental setting and one for the driving setting.
...
perform at least one user test with **three different users** that represent your target users determined
...
## Ethical questions
Use the [Ethical Decision Making framework](https://www.scu.edu/ethics/ethics-resources/ethical-decision-making/) to argument **at least 2 ethical dilemmas** according
